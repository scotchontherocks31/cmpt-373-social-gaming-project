...
TEST(ExpressionASTStructure,UnaryWithSize) {
  ...
  std::string answer = "(BinaryNode:\".\"(VariableExpression\"winners\")(VariableExpression\"size\"))";
...
TEST(ExpressionASTStructure,BinaryWithEquals) {
  ...
  std::string answer = "(BinaryNode:\"==\"(BinaryNode:\".\"(VariableExpression\"winners\")(VariableExpression\"size\"))(BinaryNode:\".\"(VariableExpression\"players\")(VariableExpression\"size\")))";
  std::string output = printer.returnOutput();
...
TEST(ExpressionASTStructure,UnaryandFunction) {
  ...
  std::string answer = "(UnaryNode:\"!\"(BinaryNode:\".\"(BinaryNode:\".\"(BinaryNode:\".\"(VariableExpression\"players\")(VariableExpression\"elements\"))(VariableExpression\"weapon\"))(FunctionCallNode:\"contains\"(VariableExpression\"contains\")(BinaryNode:\".\"(VariableExpression\"weapon\")(VariableExpression\"name\")))))";
  std::string output = printer.returnOutput();
